...
export default function ManageRoles() {
    ...
    useEffect(() => {
        fetch("http://localhost:8080/api/vitri")
            .then((res) => res.json())
            .then(setRoles);
    }, []);
    ...
    const handleSave = async (e) => {
        ...
        const url =
            modalMode === "add"
                ? "http://localhost:8080/api/vitri"
                : `http://localhost:8080/api/vitri/${selectedRole.id}`;
    ...
    const handleDelete = async () => {
        ...
        await fetch(`http://localhost:8080/api/vitri/${selectedRole.id}`, {
            method: "DELETE",
        });
